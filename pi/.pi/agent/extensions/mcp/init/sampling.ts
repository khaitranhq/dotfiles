// init/sampling.ts - MCP sampling handler (no UI confirmation)
import {
  complete,
  type Api,
...
export async function handleSamplingRequest(
  ...
  if (!options.autoApprove) {
    throw new Error("MCP sampling requires autoApprove. Set settings.samplingAutoApprove to true.");
  }
