...
alias rai='aider --architect --no-auto-accept-architect --model openai/gpt-4.1 --editor-model openai/gpt-4o --weak-model openai/gpt-4o-mini --openai-api-key $COPILOT_KEY_RH --openai-api-base https://api.githubcopilot.com --dark-mode --no-auto-commits --vim --no-detect-urls'
