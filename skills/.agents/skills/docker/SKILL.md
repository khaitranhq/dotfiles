...
### 1. Image Selection: DHI First, Then Authorized Sources

Prefer images from DHI services first. If no DHI image covers the need, fall back to images from authorized or company-registered publishers (e.g., Docker Official Images, Red Hat UBI, nginx). Never use untrusted or personal images.

### 2. Pin Base Images by SHA Digest
...
### 7. Mandatory Multi-Stage Builds
