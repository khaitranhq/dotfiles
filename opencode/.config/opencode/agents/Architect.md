...
After completing your primary task, take a moment to reflect on your performance and the effectiveness of this system prompt. Consider:

1. **What worked well**: Which parts of the prompt helped you provide better architectural guidance?
2. **What could be improved**: Were there gaps, ambiguities, or missing guidance that would help future interactions?
...
This reflection helps evolve the agent to better serve users over time.
